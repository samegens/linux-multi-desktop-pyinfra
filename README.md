...
Google Fonts, inotify watch/instance sysctl limits, Fastfetch, Dropbox, NFS/SSHFS mounts,
Gitleaks, TruffleHog — all verified idempotent on both Mint (`mint_vm` test VM) and Fedora
(`localhost`).
