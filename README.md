...
venvs (`~/python3-venv/*`, incl. this repo's own `pyinfra-latest`) — all verified idempotent on
both Mint (`remote` test VM) and Fedora (`localhost`).
...
Cinc Auditor, desktop-environment placeholder.
